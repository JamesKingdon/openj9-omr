...
CREATED IN ERROR, NOT BEING used

See ...openj9/runtime/gc_glue_java/configure_includes/configure_linux_aarch64.mk


# aarch64 is always 64 bit
TEMP_TARGET_DATASIZE:=64

# how would you get here without it being linux_aarch64? (or should that be linux_aarch64_linaro?)
